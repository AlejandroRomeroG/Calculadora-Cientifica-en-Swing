 ...
 * 
 * @author:  Alejandro Romero González y el profe 
 * @version:  1.0 
 * @date: 06-09-2015 
 */
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		super();
		setSize(450, 500);
		setTitle("Calculadora Mas Chida - Alejandro Romero González 5IM9");
	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado = Math.sinh(new Double(pantalla.getText()));
		}
